...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(grader_php)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(grader_php)
ZEND_DECLARE_MODULE_GLOBALS(grader_php)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(grader_php_globals_id, zend_grader_php_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(grader_php_globals_id, zend_grader_php_globals *, error_code )
#else
#define SWIG_ErrorMsg() (grader_php_globals.error_msg)
#define SWIG_ErrorCode() (grader_php_globals.error_code)
#endif
...
static void grader_php_init_globals(zend_grader_php_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void grader_php_destroy_globals(zend_grader_php_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_grader_php_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_grader_php_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_submit_new_task) {
  ...
  result = (char *)submit_new_task(arg1,arg2,arg3);
  {
    if(!result) {
...
ZEND_NAMED_FUNCTION(_wrap_get_task_status) {
  ...
  result = (char *)get_task_status(arg1);
  {
    if(!result) {
      ZVAL_NULL(return_value);
    } else {
...
static zend_function_entry grader_php_functions[] = {
 SWIG_ZEND_NAMED_FE(submit_new_task,_wrap_submit_new_task,NULL)
 SWIG_ZEND_NAMED_FE(get_task_status,_wrap_get_task_status,NULL)
 SWIG_ZEND_NAMED_FE(destroy_task,_wrap_destroy_task,NULL)
 SWIG_ZEND_NAMED_FE(swig_grader_php_alter_newobject,_wrap_swig_grader_php_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_grader_php_get_newobject,_wrap_swig_grader_php_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry grader_php_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"grader_php",
    grader_php_functions,
    PHP_MINIT(grader_php),
    PHP_MSHUTDOWN(grader_php),
    PHP_RINIT(grader_php),
    PHP_RSHUTDOWN(grader_php),
    PHP_MINFO(grader_php),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &grader_php_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &grader_php_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(grader_php)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(grader_php, grader_php_init_globals, grader_php_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(grader_php_globals_id);
#endif
    return SUCCESS;
}
